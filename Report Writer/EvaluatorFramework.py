...
from OnePassWriter import one_pass_writer
from MoAWriter import MoAWriter
...
if __name__ == "__main__":
    ...
    models = [
        ...
        # "ollama/qwen2:1.5b @ MoA 6", # RUN
        # "ollama/qwen2:1.5b @ MoA 7",
        # "ollama/qwen2:1.5b @ MoA 8", # RUN
        # "ollama/phi3.5:latest @ 1Pass",
        # "ollama/phi3.5:latest @ MoA 1", # RUN
        # "ollama/phi3.5:latest @ MoA 2", # RUN
        # "ollama/phi3.5:latest @ MoA 3",
        # "ollama/phi3.5:latest @ MoA 4", # RUN
        # "ollama/phi3.5:latest @ MoA 5",
        # "ollama/phi3.5:latest @ MoA 6", # RUN
        # "ollama/phi3.5:latest @ MoA 7",
        # "ollama/phi3.5:latest @ MoA 8", # RUN
        # "gemini-1.5-flash @ 1Pass", # RUN
        # "gemini-1.5-pro @ 1Pass", # RUN
    ]
